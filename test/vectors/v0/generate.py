...
def event(id_, kind="lync/artifact", at="2026-07-06T04:10:00Z", author=None, parents=None, payload=None, **extra):
    obj = {
        "v": 1,
        "id": id_,
        "kind": kind,
...
def main():
    ...
    write_fixture("01-valid-events", [("input.lync", [a, spliced(b), spliced(c, "QUJDRA=="), d], False)], {
        "fixture": "01-valid-events",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000001", "has_digest": False, "has_sig": False},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000002", "has_digest": True, "has_sig": False},
            {"file": "input.lync", "line": 3, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000003", "has_digest": True, "has_sig": True},
            {"file": "input.lync", "line": 4, "class": "nonconforming", "id": "018f0000-0000-7000-8000-000000000004", "reason": "final line missing LF; still accepted and view-eligible"},
        ],
        "union_event_ids": [
    ...
    write_fixture("02-splice-anchoring", [("input.lync", [spliced(p1), spliced(p2), near_splice, top_reserved], True)], {
        "fixture": "02-splice-anchoring",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000011", "reason": "payload marker-like bytes are not a splice"},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000012", "reason": "reserved names inside payload are allowed"},
            {"file": "input.lync", "line": 3, "class": "garbage", "reason": "near-splice is body; parsed body contains reserved top-level digest"},
            {"file": "input.lync", "line": 4, "class": "garbage", "reason": "top-level digest in body is reserved"},
        ],
    ...
    dup_inside_damaged = '{"v":1,"id":"018f0000-0000-7000-8000-000000000022","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"deepfates"},"parents":[],"payload":{"x":1,"x":2}}'
    write_fixture("03-damaged-digest", [("input.lync", [spliced(damaged_body, override_digest="f" * 64), spliced(dup_inside_damaged, override_digest="e" * 64)], True)], {
        "fixture": "03-damaged-digest",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "damaged", "reason": "sha256 mismatch"},
            {"file": "input.lync", "line": 2, "class": "damaged", "reason": "sha256 mismatch; do not parse duplicate member names after damage"},
        ],
        "union_event_ids": [],
        "view_eligible_ids": [],
    })
    ...
    garbage_lines = [
        '{"v":1,"id":"dup-depth","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"a"},"parents":[],"payload":{"x":1,"x":2}}',
        ' {"v":1,"id":"leading-space","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"a"},"parents":[],"payload":{}}',
        '{"v":1,"id":"bad-kind","kind":"noslashname","at":"2026-07-06T04:10:00Z","author":{"actor":"a"},"parents":[],"payload":{}}',
        '{"v":2,"id":"unimplemented-v","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"a"},"parents":[],"payload":{}}',
        '',
        '{"v":1,"id":"crlf","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"a"},"parents":[],"payload":{}}\r',
        spliced(good_after_bad),
    ]
    write_fixture("04-garbage-classes", [("input.lync", garbage_lines, True)], {
        "fixture": "04-garbage-classes",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "garbage", "reason": "duplicate member name at nested object depth"},
            {"file": "input.lync", "line": 2, "class": "garbage", "reason": "bytes outside object: leading whitespace"},
            {"file": "input.lync", "line": 3, "class": "garbage", "reason": "kind lacks namespace/name slash"},
            {"file": "input.lync", "line": 4, "class": "garbage", "reason": "unimplemented v"},
            {"file": "input.lync", "line": 5, "class": "garbage", "reason": "empty line"},
            {"file": "input.lync", "line": 6, "class": "garbage", "reason": "CR before LF is trailing content"},
            {"file": "input.lync", "line": 7, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000031"},
        ],
    ...
    write_fixture("05-conflicts-and-duplicates", [("input.lync", [spliced(same), spliced(same), same_alt_meta, spliced(conflict_a), spliced(conflict_b), spliced(meta_disagree_body), meta_disagree_body], True)], {
        "fixture": "05-conflicts-and-duplicates",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000041"},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000041", "duplicate_sighting": True},
            {"file": "input.lync", "line": 3, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000041", "duplicate_sighting": True, "metadata_disagreement": True},
            {"file": "input.lync", "line": 4, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000042"},
            {"file": "input.lync", "line": 5, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000042"},
            {"file": "input.lync", "line": 6, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000043"},
            {"file": "input.lync", "line": 7, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000043", "duplicate_sighting": True, "metadata_disagreement": True},
        ],
    ...
    write_fixture("06-graph-obstacles", [("input.lync", [spliced(ca), spliced(cb), spliced(child_cycle), spliced(dangling), spliced(conf_a), spliced(conf_b), spliced(child_conf)], True)], {
        "fixture": "06-graph-obstacles",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000051"},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000052"},
            {"file": "input.lync", "line": 3, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000053"},
            {"file": "input.lync", "line": 4, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000054"},
            {"file": "input.lync", "line": 5, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000055"},
            {"file": "input.lync", "line": 6, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000055"},
            {"file": "input.lync", "line": 7, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000056"},
        ],
        "union_event_ids": [
    ...
    write_fixture("07-critical-suppression", [("input.lync", [spliced(t_actor), spliced(t_operator), spliced(t_import), spliced(t_bob), spliced(t_empty), spliced(crit), spliced(crit_spoof), spliced(crit_empty), damaged_crit], True)], {
        "fixture": "07-critical-suppression",
        "inputs": ["input.lync"],
        "reader_assumption": "ignorant of future/embargo",
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000061"},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000062"},
            {"file": "input.lync", "line": 3, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000063"},
            {"file": "input.lync", "line": 4, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000064"},
            {"file": "input.lync", "line": 5, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000065"},
            {"file": "input.lync", "line": 6, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000066"},
            {"file": "input.lync", "line": 7, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000067"},
            {"file": "input.lync", "line": 8, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000068"},
            {"file": "input.lync", "line": 9, "class": "damaged", "reason": "critical damaged line suppresses nothing"},
        ],
        "suppression": {
    ...
    escaped_id = '{"v":1,"id":"spell-\\u0061","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"\\u0061lice"},"parents":[],"payload":{"text":"escaped id and actor"}}'
    plain_same_id = '{"v":1,"id":"spell-a","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"alice"},"parents":[],"payload":{"text":"same decoded id, different body"}}'
    escaped_kind = '{"v":1,"id":"018f0000-0000-7000-8000-000000000071","kind":"lync\\u002fartifact","at":"2026-07-06T04:10:00Z","author":{"actor":"bob"},"parents":["spell-a"],"payload":{}}'
    dup_escaped_keys = '{"v":1,"id":"018f0000-0000-7000-8000-000000000072","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"bob"},"parents":[],"payload":{"a":1,"\\u0061":2}}'
    target_spelled = '{"v":1,"id":"018f0000-0000-7000-8000-000000000073","kind":"lync/artifact","at":"2026-07-06T04:10:00Z","author":{"actor":"\\u0061lice"},"parents":[],"payload":{"text":"suppression target"}}'
    ...
    write_fixture("08-spelling-vs-value", [("input.lync", [spliced(escaped_id), spliced(plain_same_id), spliced(escaped_kind), dup_escaped_keys, spliced(target_spelled), spliced(suppress_plain)], True)], {
        "fixture": "08-spelling-vs-value",
        "inputs": ["input.lync"],
        "reader_assumption": "ignorant of future/embargo",
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "conflict-variant", "id": "spell-a", "reason": "decoded id equals line 2, body differs"},
            {"file": "input.lync", "line": 2, "class": "conflict-variant", "id": "spell-a", "reason": "decoded id equals line 1, body differs"},
            {"file": "input.lync", "line": 3, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000071", "reason": "decoded kind contains slash"},
            {"file": "input.lync", "line": 4, "class": "garbage", "reason": "duplicate decoded member name in payload"},
            {"file": "input.lync", "line": 5, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000073"},
            {"file": "input.lync", "line": 6, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000074"},
        ],
    ...
    write_fixture("09-marked-at-semantics", [("input.lync", [spliced(marked_ok), spliced(leap), spliced(bad_at), spliced(bad_marked)], True)], {
        "fixture": "09-marked-at-semantics",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000081", "marked_effective": "2026-07-07T01:02:03.123456Z"},
            {"file": "input.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000082"},
            {"file": "input.lync", "line": 3, "class": "garbage", "reason": "at fails RFC3339 ABNF"},
            {"file": "input.lync", "line": 4, "class": "garbage", "reason": "marked fails RFC3339 ABNF"},
        ],
    ...
    write_fixture("10-merge-union", [
        ("a.lync", [spliced(m1), spliced(m2), spliced(m_conf_a)], True),
        ("b.lync", [spliced(m2), spliced(m3), spliced(m_conf_b)], True),
    ], {
        "fixture": "10-merge-union",
        "inputs": ["a.lync", "b.lync"],
        "line_classifications": [
            {"file": "a.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000091"},
            {"file": "a.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000092"},
            {"file": "a.lync", "line": 3, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000094"},
            {"file": "b.lync", "line": 1, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000092", "duplicate_sighting": True},
            {"file": "b.lync", "line": 2, "class": "accepted", "id": "018f0000-0000-7000-8000-000000000093"},
            {"file": "b.lync", "line": 3, "class": "conflict-variant", "id": "018f0000-0000-7000-8000-000000000094"},
        ],
        "union_event_ids": [
    ...
    write_fixture("11-nonconforming-carried", [("input.lync", [spliced(unknown_top), spliced(unknown_author)], True)], {
        "fixture": "11-nonconforming-carried",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "nonconforming", "id": "018f0000-0000-7000-8000-000000000101", "reason": "unknown top-level field carried and surfaced"},
            {"file": "input.lync", "line": 2, "class": "nonconforming", "id": "018f0000-0000-7000-8000-000000000102", "reason": "unknown author field carried and surfaced"},
        ],
    ...
    write_fixture("12-invalid-sig-splice", [("input.lync", [invalid_sig], True)], {
        "fixture": "12-invalid-sig-splice",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "garbage", "reason": "invalid sig grammar means no splice; reserved top-level digest/sig remain in body"},
        ],
        "union_event_ids": [],
        "view_eligible_ids": [],
    })
    ...
    write_fixture("13-sig-without-digest", [("input.lync", [sig_without_digest], True)], {
        "fixture": "13-sig-without-digest",
        "inputs": ["input.lync"],
        "line_classifications": [
            {"file": "input.lync", "line": 1, "class": "garbage", "reason": "sig without digest is not a valid splice; reserved top-level sig remains in body"},
        ],
        "union_event_ids": [],
        "view_eligible_ids": [],
    })
